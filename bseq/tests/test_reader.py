...
"""
import tempfile
from bseq.reader import read_fasta_file, read_fasta_alignment
...
class TestReadFastaAlignment:
    ...
    def test_read_fasta_alignment(self):
        seq_list = read_fasta_alignment(self.path)
        assert len(seq_list) == 30
